"""
URL configuration for the Adoptify Pet Finder backend project.

This module defines the URL patterns for the application, routing incoming HTTP requests
to the appropriate views. It includes endpoints for:
- Admin panel access
...
- Shelter management
- Pet management
- Favourite pets functionality
- Donation management

Additionally, it serves media files during development when `DEBUG` is enabled.
"""
